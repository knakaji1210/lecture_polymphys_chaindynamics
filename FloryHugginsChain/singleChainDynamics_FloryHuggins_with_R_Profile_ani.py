...
if initConfig == "F": # Fully Extendedからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_FloryHuggins_N{0}_{1}steps_FE_with_R".format(N, t_max)
if initConfig == "R": # Fully Extendedからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_FloryHuggins_N{0}_{1}steps_RC_with_R".format(N, t_max)
